function Angular() {
    return (
        <div id="angular" className="flex flex-col items-end pb-44">
            ...
            Alias aliquam aperiam explicabo enim voluptatibus omnis labore laborum ut iure fugiat porro optio vel, totam debitis consequuntur non in hic blanditiis reprehenderit illum tempora adipisci minima laboriosam eligendi! Eaque!
            Beatae fugiat, rem dolorem repellendus doloremque, harum optio, quia ipsa sed inventore consequuntur commodi quisquam. Porro voluptatem ullam harum odio sed impedit quis nostrum consequatur reprehenderit? Maxime fuga consectetur molestiae!</p>
        </div>
    )
}
