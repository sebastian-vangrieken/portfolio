function Stage() {
    return (
        <div id="stage" className="flex flex-col items-end pb-44">
            ...
            Laudantium nostrum commodi a possimus. Voluptatum, rerum aliquid voluptatem tempore laudantium eos deserunt recusandae itaque sunt cupiditate vero tempora incidunt aut enim, dolorem deleniti asperiores! Numquam earum molestias saepe iusto.
            Temporibus, quaerat. Id error neque iste vero illo, cumque fugit dicta tenetur voluptatibus eos voluptatum praesentium non, veniam amet impedit ea necessitatibus commodi repellat similique officiis magni! Veritatis, nulla dolores.</p>
        </div>
    )
}
