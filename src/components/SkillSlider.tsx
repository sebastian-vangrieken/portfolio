    ...
    return (
        <div className="w-fit my-4">
            <svg height={26} width={306}>
                <text x="5" y="12" fontSize={16} fill={text}>{skill}</text>
                <line x1="5" y1="20" x2="300" y2="20" strokeLinecap="round" strokeWidth="8" stroke="#EEE" />
                <line x1="5" y1="20" x2={3 * proficiency} y2="20" style={{ stroke:color, strokeWidth:'8', strokeLinecap:'round' }} />
