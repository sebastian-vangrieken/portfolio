    ...
    return (
        <div id="about" className="flex flex-col items-end pb-44">
            ...
            <p className="flex-wrap w-3/4">
                ...
                Naast tennis heb ik sinds dit jaar ook lopen opgenomen. In april heb ik al meegedaan aan de 10 miles in Antwerpen, en een marathon staat ook al ingeplant voor dit jaar.
            </p>
        </div>
    )
}
