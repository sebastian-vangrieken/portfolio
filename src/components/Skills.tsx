...
function Skills({ darkMode } : SkillsProps) {
    return (
        <div id="skills" className="pb-44">
            <h1 className="text-3xl font-bold border-b-4 w-fit mb-12 border-highlightl dark:border-highlightd">Skills</h1>
                ...
                <div>
                    ...
                    <div>
                        ...
                        <div className="flex items-center">
                            ...
                            <SkillSlider skill="Typescript" proficiency={70} darkMode={darkMode} />
                        </div>
                    </div>
                </div>
                <div>
